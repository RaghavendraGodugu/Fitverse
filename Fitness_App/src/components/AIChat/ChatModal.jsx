          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4 hide-scrollbar">
            {messages.map((msg) => (
              ...
              >
                ...
                <div
                  className={cn(
                    'py-2.5 px-4 rounded-2xl text-sm leading-relaxed whitespace-pre-wrap',
                    msg.role === 'user'
          ...
          <div className="px-4 pb-2 flex gap-2 overflow-x-auto hide-scrollbar whitespace-nowrap">
            {suggestedReplies.map((reply, i) => (
              <button
                ...
                disabled={isTyping}
                className="text-xs px-3 py-1.5 rounded-full border border-brand-500/30 text-brand-300 hover:bg-brand-500/10 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {reply}
              </button>
            ))}
